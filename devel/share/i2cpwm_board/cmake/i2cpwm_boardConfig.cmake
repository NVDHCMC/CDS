...
if("TRUE" STREQUAL "TRUE")
  set(i2cpwm_board_SOURCE_PREFIX /home/ubuntu/catkin_ws/src/ros-i2cpwmboard-master)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'i2cpwm_board' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'bradanlane <locoro@bradanlane.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'i2cpwm_board' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/catkin_ws/src/ros-i2cpwmboard-master/${idir}'.  Ask the maintainer 'bradanlane <locoro@bradanlane.com>' to fix it.")
    endif()
...
set(i2cpwm_board_EXPORTED_TARGETS "i2cpwm_board_generate_messages_cpp;i2cpwm_board_generate_messages_lisp;i2cpwm_board_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${i2cpwm_board_dep}_FOUND)
      find_package(${i2cpwm_board_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${i2cpwm_board_dep} REQUIRED ${depend_list})
  endif()
